...
class WeapInfo_t //interesting stuff here
{
public:
...
public:
	...
	NETVAR(float_t, m_takeDamage, "CCSPlayer", "m_takeDamage ");
	...
	NETVAR(bool, m_bSpotted, "CCSPlayer", "m_bSpotted");
	...
	NETVAR(Vector, m_aimPunchAngleVel, "CBasePlayer", "m_aimPunchAngleVel");
	...
	NETVAR(int, m_hGroundEntity_, "CBasePlayer", "m_hGroundEntity_");
	...
	bool CheckOnGround()
	{
		...
		bool onGround2 = (m_fFlags() & FL_ONGROUND);
		bool onGround4 = m_hGroundEntity_() != -1;
		bool onGround3 = false;


		return onGround1 || onGround2 || onGround3;
	}
...
class PlayerList_t //since my plist was broken i put this in for now
{
public:
