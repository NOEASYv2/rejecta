...
public:
	...
	{
		VT::vfunc<void(__thiscall*)(void*, Vector&, Vector&, float&, int, int, int, int, float)>(this, 24)(this, mins, maxs, pillradius, r, g, b, a, duration); //this shit should be 23 but its crashing me so fuckt this imma sleep now!
	}
};