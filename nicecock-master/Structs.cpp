...
bool C_BaseEntity::IsPlayer()
{
	...
	return VT::vfunc<bool(__thiscall*)(C_BaseEntity*)>(this, 151)(this);
}
...
bool C_BaseEntity::IsWeapon()
{
	...
	return VT::vfunc<bool(__thiscall*)(C_BaseEntity*)>(this, 169)(this);
}

auto C_BasePlayer::IsGood() -> bool
{
...
WeapInfo_t *C_BaseCombatWeapon::GetWeapInfo()
{
	...
	return VT::vfunc<o_getWeapInfo>(this, 447)(this); // 456
}
...
{
	return VT::vfunc<float(__thiscall*)(void*)>(this, 470)(this); // 24.3.18
}
...
{
	return VT::vfunc<void(__thiscall*)(void*)>(this, 471)(this); // 24.3.18
}
...
void C_BasePlayer::SetAngle2(const Vector wantedang)
{
	typedef void(__thiscall* SetAngleFn)(void*, const Vector &);
	static SetAngleFn SetAngle = (SetAngleFn)Utils::PatternScan(GetModuleHandle("client.dll"), "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8");
...
void C_BasePlayer::UpdateAnimationState(CCSGOPlayerAnimState *state, QAngle angle)
{
	...
	static auto UpdateAnimState = (fnUpdateAnimState)Utils::PatternScan(GetModuleHandle("client.dll"), "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24");
	if (!UpdateAnimState)
		return;
...
void C_BasePlayer::UpdateClientSideAnimation()
{
	...
	return VT::vfunc<o_updateClientSideAnimation>(this, 218)(this);
}
...
int C_BasePlayer::Rank(int index)
{
	return *(int*)((DWORD)Offsets::playerResource + 0x1A94 + index * 4);
}

int C_BasePlayer::Wins(int index)
{
	return *(int*)((DWORD)Offsets::playerResource + 0x1B98 + index * 4);
}

CollisionProperty* C_BasePlayer::GetCollision()
{
