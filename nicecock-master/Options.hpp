...
public:
	...
	OPTION(bool, misc_flashlight, false);
	OPTION(bool, misc_flashlight_shadows, false);
	OPTION(ButtonCode_t, misc_flashlight_bind, BUTTON_CODE_NONE);
	OPTION(int, misc_flashlight_fov, 10);
	OPTION(int, misc_flashlight_distance, 1000);
	OPTION(int, misc_flashlight_alpha, 1000);
