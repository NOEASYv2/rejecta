...
std::unique_ptr<VFTableHook> g_MdlRenderHook = nullptr;
...
OverrideConfig_t o_OverrideConfig = nullptr;
...
void Installer::installGladiator()
{
	...
	g_MdlRenderHook = std::make_unique<VFTableHook>((PPDWORD)g_MdlRender, true);
