...
WeapInfo_t *C_BaseCombatWeapon::GetWeapInfo()
{
	...
	return VT::vfunc<o_getWeapInfo>(this, 447)(this); // 24.3.18
}
...
{
	return *(float_t*)((uintptr_t)this + 0xAD4);
}
...
{
	return *(int*)((DWORD)Offsets::playerResource + 0x1A44 + index * 4);
}

int C_BasePlayer::Wins(int index)
{
	return *(int*)((DWORD)Offsets::playerResource + 0x1B48 + index * 4);
}
